...
def process_file(filename, fields):
    ...
    with open(filename, "r") as f:
        ...
        for line in reader:
			...
			entry = {
                    "synonym": is_null(fix_synonym(line['synonym'])), 
                    "name": fix_name(line['name'],fix_label(is_null(line['rdf-schema#label']))), 
                    "classification": {
                    ...
                    "label":  fix_label(is_null(line['rdf-schema#label'])), 
